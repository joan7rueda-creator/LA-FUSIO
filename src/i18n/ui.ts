...
export const ui = {
  ca: {
    ...
    'fusion.pasteleria.imageLabel': 'Pastisseria — obrador i creacions artesanals',
    'fusion.flores.title': 'Flors',
    'fusion.flores.desc': "Color, natura i composicions que et pots endur.",
    'fusion.flores.imageLabel': 'Flors — composició floral sobre la barra',
  ...
  es: {
    ...
    'fusion.pasteleria.imageLabel': 'Pastelería — obrador y creaciones artesanales',
    'fusion.flores.title': 'Flores',
    'fusion.flores.desc': 'Color, naturaleza y composiciones que puedes llevar contigo.',
    'fusion.flores.imageLabel': 'Flores — composición floral sobre la barra',
